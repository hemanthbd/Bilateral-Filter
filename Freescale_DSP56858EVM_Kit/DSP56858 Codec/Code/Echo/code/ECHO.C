...
asm int HEcho(int x, int y, int z)
{
	MAC A1,Y1,Y0   /*  A1 contains the attenuation, Y1 contains the past output value and Y0 contains the current sample value.
				   Multiply A1 and Y1 and add to Y0. The output value will be stored in Y0. */
	rts
}
/*******************************************************************************
*
