...
volatile asm void _vect(void) {
  ...
  JSR  EInt1_Interrupt                 /* Interrupt no. 17 (Used)   - ivINT_IRQA  */
  JSR  EInt2_Interrupt                 /* Interrupt no. 18 (Used)   - ivINT_IRQB  */
...
/*lint -esym(765,EInt1_Interrupt) Disable MISRA rule (23) checking for symbols (EInt1_Interrupt). */
/*lint -esym(765,EInt2_Interrupt) Disable MISRA rule (23) checking for symbols (EInt2_Interrupt). */
