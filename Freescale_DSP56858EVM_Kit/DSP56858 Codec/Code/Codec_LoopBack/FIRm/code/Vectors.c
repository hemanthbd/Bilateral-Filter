...
volatile asm void _vect(void) {
  ...
  JSR  IRQA_Interrupt                  /* Interrupt no. 17 (Used)   - ivINT_IRQA  */
  JSR  IRQB_Interrupt                  /* Interrupt no. 18 (Used)   - ivINT_IRQB  */
  ...
  JSR  Inhr2_InterruptRxWE             /* Interrupt no. 28 (Used)   - ivINT_ESSI0_RxWE  */
  JSR  Inhr2_InterruptRx               /* Interrupt no. 29 (Used)   - ivINT_ESSI0_Rx  */
  JSR  Cpu_Interrupt                   /* Interrupt no. 30 (Unused) - ivINT_ESSI0_RxLS  */
  JSR  Inhr2_InterruptTxWE             /* Interrupt no. 31 (Used)   - ivINT_ESSI0_TxWE  */
  JSR  Inhr2_InterruptTx               /* Interrupt no. 32 (Used)   - ivINT_ESSI0_Tx  */
  ...
  JSR  Cpu_Interrupt                   /* Interrupt no. 42 (Unused) - ivINT_SCI0_TxEmpty  */
  JSR  Cpu_Interrupt                   /* Interrupt no. 43 (Unused) - ivINT_SCI0_TxIdle  */
  JSR  Cpu_Interrupt                   /* Interrupt no. 44 (Unused) - ivINT_SCI0_RxIdle  */
  JSR  Cpu_Interrupt                   /* Interrupt no. 45 (Unused) - ivINT_SCI0_RxError  */
  JSR  Cpu_Interrupt                   /* Interrupt no. 46 (Unused) - ivINT_SCI0_RxFull  */
...
/*lint -esym(765,IRQA_Interrupt) Disable MISRA rule (23) checking for symbols (IRQA_Interrupt). */
/*lint -esym(765,IRQB_Interrupt) Disable MISRA rule (23) checking for symbols (IRQB_Interrupt). */
/*lint -esym(765,Inhr2_InterruptRxWE) Disable MISRA rule (23) checking for symbols (Inhr2_InterruptRxWE). */
/*lint -esym(765,Inhr2_InterruptRx) Disable MISRA rule (23) checking for symbols (Inhr2_InterruptRx). */
/*lint -esym(765,Inhr2_InterruptTxWE) Disable MISRA rule (23) checking for symbols (Inhr2_InterruptTxWE). */
/*lint -esym(765,Inhr2_InterruptTx) Disable MISRA rule (23) checking for symbols (Inhr2_InterruptTx). */
