...
void PE_low_level_init(void)
{
  ...
  /* GPIO_D_DR: D&=~32 */
  clrReg16Bits(GPIO_D_DR, 32U);         
  /* GPIO_D_DDR: DD|=32 */
  setReg16Bits(GPIO_D_DDR, 32U);        
  /* GPIO_D_PER: PE&=~32 */
  clrReg16Bits(GPIO_D_PER, 32U);        
  /* GPIO_C_PER: PE=39 */
  clrSetReg16Bits(GPIO_C_PER, 24U, 39U); 
  /* IPR3: ESSI0_TD_IPL=2,ESSI0_TDES_IPL=2,ESSI0_RLS_IPL=2,ESSI0_RD_IPL=2,ESSI0_RDES_IPL=2 */
  clrSetReg16Bits(IPR3, 21824U, 43648U); 
  /* IPR4: ESSI0_TLS_IPL=2 */
  clrSetReg16Bits(IPR4, 1U, 2U);        
  /* GPIO_C_DR: D&=~24 */
  clrReg16Bits(GPIO_C_DR, 24U);         
  /* GPIO_C_DDR: DD|=24 */
  setReg16Bits(GPIO_C_DDR, 24U);        
  /* GPIO_E_DR: D&=~12 */
  clrReg16Bits(GPIO_E_DR, 12U);         
  /* GPIO_E_DDR: DD|=12 */
  setReg16Bits(GPIO_E_DDR, 12U);        
  /* GPIO_E_PER: PE&=~12 */
  clrReg16Bits(GPIO_E_PER, 12U);        
  /* ICTL: IRQB_EDG=1,IRQA_EDG=1 */
  setReg16Bits(ICTL, 3U);               
  /* ### FreescaleSSI "Inhr2" init code ... */
  Inhr2_Init();
  /* ### Audio_Codec_CS4218 "Codec" init code ... */
  Codec_codecInit();
  /* ### External interrupt "IRQA" init code ... */
  setRegBitGroup(IPR2,IRQA_IPL,2);     /* Set-up priority level and enable interrupt "INT_IRQA" */
  /* ### External interrupt "IRQB" init code ... */
  setRegBitGroup(IPR2,IRQB_IPL,2);     /* Set-up priority level and enable interrupt "INT_IRQB" */
