...
{
  /* ESSI_0_SCR2: RIE=0,TIE=0,RE=0,TE0=0,TE1=0,TE2=0,??=0,??=0,SYN=1,TSHFD=0,TSCKP=0,ESSIEN=0,NET=0,TFSI=0,TFSL=1,TEFS=1 */
  setReg16(ESSI_0_SCR2, 131U);          
