...
volatile asm void _vect(void) {
  ...
  JSR  Button_Interrupt                /* Interrupt no. 17 (Used)   - ivINT_IRQA  */
  JSR  EInt1_Interrupt                 /* Interrupt no. 18 (Used)   - ivINT_IRQB  */
  ...
  JSR  Time_Green_Led_Interrupt        /* Interrupt no. 61 (Used)   - ivINT_TMR3_CMP  */
...
/*lint -esym(765,Button_Interrupt) Disable MISRA rule (23) checking for symbols (Button_Interrupt). */
/*lint -esym(765,EInt1_Interrupt) Disable MISRA rule (23) checking for symbols (EInt1_Interrupt). */
/*lint -esym(765,Time_Green_Led_Interrupt) Disable MISRA rule (23) checking for symbols (Time_Green_Led_Interrupt). */
