...
void PE_low_level_init(void)
{
  ...
  /* GPIO_D_DR: D&=~5 */
  clrReg16Bits(GPIO_D_DR, 5U);          
  /* GPIO_D_DDR: DD|=5 */
  setReg16Bits(GPIO_D_DDR, 5U);         
  /* GPIO_D_PER: PE&=~5 */
  clrReg16Bits(GPIO_D_PER, 5U);         
  ...
  /* GPIO_F_DR: D&=~1 */
  clrReg16Bits(GPIO_F_DR, 1U);          
  /* GPIO_F_DDR: DD|=1 */
  setReg16Bits(GPIO_F_DDR, 1U);         
  /* GPIO_F_PER: PE&=~1 */
  ...
  /* ### TimerInt "Time_Green_Led" init code ... */
  Time_Green_Led_Init();
  /* ### BitIO "Bit1" init code ... */
  Shadow_GPIO_F_DR &= ~(word)1;        /* Initialize shadow variable */
