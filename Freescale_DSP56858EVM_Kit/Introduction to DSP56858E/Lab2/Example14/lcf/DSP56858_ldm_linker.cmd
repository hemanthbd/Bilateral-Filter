...
# 56858 memory map for LDM and 5685x boot mode 0
...
#   .p_reserved                 : ORIGIN = 0x1F0400, LENGTH = 0xFBFF     
    .x_RAM                (RW)  : ORIGIN = 0x0001,   LENGTH = 0x1FFBFF   # contiguious int/ext xRAM
#   .x_internal_RAM       (RW)  : ORIGIN = 0x0001,   LENGTH = 0x5FFF     
#   .x_external_RAM_1     (RW)  : ORIGIN = 0x6000,   LENGTH = 0x1F9C00   
    .x_onchip_peripherals (RW)  : ORIGIN = 0x1FFC00, LENGTH = 0x3FF      
    .x_external_RAM_2     (RW)  : ORIGIN = 0x1FFFFF, LENGTH = 0xDFFF01   
    .x_EOnCE              (RW)  : ORIGIN = 0xFFFF00, LENGTH = 0xFF       
}
